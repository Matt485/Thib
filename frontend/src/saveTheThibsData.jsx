...
export const saveTheThibsData = [
     ...
     tabContent: 
      <div id="tabcontent" className="w-full h-full flex items-center justify-center">
        <label id="onebomb" className="w-[50%] h-full flex flex-col items-center justify-center pt-[1.5%] pb-[0.75%] px-[3%] cursor-pointer">
          ...
          <div id="setmain" className="w-full h-[17.75%] flex items-center justify-center bg-lightblue bg-opacity-25 text-darkpurple rounded-md border-solid border-lightblue border-opacity-25 border-[1px] peer-checked:text-lightblue peer-checked:border-solid peer-checked:border-pink peer-checked:border-[1px] peer-checked:bg-darkpurple">ONE BOMB VERSION</div>
          ...
          <div className="w-full h-[15%] flex items-center justify-center gap-[5%]">
            <label className="w-[30%] h-full flex items-center justify-center cursor-pointer">
              ...
              <div id="setbtn" className="w-full h-[70%] bg-lightblue bg-opacity-25 text-darkpurple rounded-md border-solid border-lightblue border-opacity-25 border-[1px] peer-checked:text-lightblue peer-checked:border-solid peer-checked:border-pink peer-checked:border-[1px] peer-checked:bg-darkpurple">
        ...
        <label id="multibomb" className="w-[50%] h-full flex flex-col items-center justify-center pt-[1.5%] pb-[0.75%] px-[3%] cursor-pointer">
          ...
          <div id="setmain" className="w-full h-[17.75%] flex items-center justify-center bg-lightblue bg-opacity-25 text-darkpurple rounded-md border-solid border-lightblue border-opacity-25 border-[1px] peer-checked:text-lightblue peer-checked:border-solid peer-checked:border-pink peer-checked:border-[1px] peer-checked:bg-darkpurple">MULTIBOMB VERSION</div>
          <div id="setparam" className="w-full h-[5%] flex items-center justify-center mt-[4%]">TIME PER TURN</div>
          <div className="w-full h-[15%] flex items-center justify-center gap-[5%]">
            <label className="w-[30%] h-full flex items-center justify-center cursor-pointer">
    ...
    {id : '2',
     ...
     tabContent: 
     <>
      <Rulestabs className="w-full h-full" data={rules}/>
     </>
    },
  ]
